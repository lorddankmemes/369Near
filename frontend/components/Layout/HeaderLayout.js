...
export const HeaderLayout = () => {
  ...
  return (
    <>
      <header className="border-b border-none shadow-md grid md:grid-cols-1 body-container font-light fixed inset-x-0 z-50 invisible md:visible">
        <div className="flex justify-between">
          ...
          <div className="flex gap-2 items-center">
            <span className="flex gap-3">
              ...
              >
                <span className="whitespace-nowrap px-[0.75em] py-[1em] rounded-md hover:bg-purple-100 text-[#efefef] hover:text-purple-700">
                  NEAR
                </span>
                ...
                {toggleOpen ? (
                  <div className="z-50 w-56 absolute translate-y-14 bg-white rounded-xl">
                    <div className="relative m-6">
                      <span className="whitespace-nowrap rounded-full mx-4 bg-purple-100 px-2.5 py-0.5 text-sm text-purple-700">
                        NEAR
                      </span>
              ...
              <NavLink className="navbar grid content-center" to="/Marketplace">
                Marketplace
              </NavLink>
              <NavLink className="navbar grid content-center" to="/Auctions">
                Auction
              </NavLink>
              <NavLink className="navbar grid content-center" to="/Activity">
                Activity
              </NavLink>
            </span>

            <a
              className="bg-white text-black px-[0.75em] py-[1.2em] rounded-md"
                ...
                <div className="space-y-3">
                  <div className="relative my-4 mx-2">
                    ...
                    <input
                      ...
                      name="Search"
                      placeholder="Search..."
                      className="w-full py-2 pl-10 text-sm outline outline-offset-2 outline-1 rounded-md focus:outline-black "
                    />
                  </div>
