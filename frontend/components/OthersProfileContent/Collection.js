...
export const Collection = (props) => {
  ...
  const selectedCollection = data.sale_collectibles.collectibles_user.fullName;

  const filteredNFTs = test.result.filter(nft => nft.sale_collectibles.collectibles_user.fullName === selectedCollection);
