                    ...
                    <div className="flex gap-x-4">
                      ...
                      <span>
                        ...
                        <div className="font-extrabold w-80 block truncate ">
                          {data.sale_collectibles.collectibles_user.username}
                        </div>
                      </span>
                    </div>
                    <div className="flex gap-x-4">
                    ...
                    <div className="flex gap-x-4">
                      ...
                      <span>
                        ...
                        <div className="font-extrabold">
                          {
                            data.sale_collectibles.collectible_collection
                              .tokenName
                          }
                        </div>
                      </span>
                  ...
                  <div className="grid gap-6 px-6">
                    <div className="flex gap-x-4">
                      <span>
                        <img
                          src={
                            data.sale_collectibles.collectibles_user
                              .profile_photo_path
                          }
                          className="creator-size"
                        />
          ...
          <div className="flex flex-col gap-y-8 justify-center bg-white rounded-lg text-black my-6 p-20 mx-1 lg:mx-48">
            <div>
              ...
              <div className="font-medium text-md text-gray-500 pt-8">
                The Aurora Camel NFTs are the first in this collection to be
                released. The Aurora Camels is a collection of 274 uniquely
                generated digital collectibles living on the Aurora & Near
                blockchain.
              </div>
            </div>
